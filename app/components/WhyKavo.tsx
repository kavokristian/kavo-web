...
const reasons = [
  ...
  {
    title: "Fast og forutsigbar pris",
    description:
      "7 500 kr betaler du én gang. Deretter 500 kr i måneden. Ingen overraskelser.",
    icon: IconCoin,
  },
  {
...
export function WhyKavo() {
  return (
    <section className="scroll-mt-24 bg-atmosphere-subtle py-20 sm:py-28">
